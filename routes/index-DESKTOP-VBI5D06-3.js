...
router.get('/simulation/:charttyp/:coortyp/:typname', function(req, res, next) {
  ...
  if (charttyp=='radar'){
      ...
      if (coortyp=='xcoord'){
          selection = {
          text: 'SELECT * FROM simulation.tb_ens_zonal WHERE name = $1 ORDER BY ts ASC',
          values: [typname],
        }
      } else if (coortyp=='ycoord'){
          selection = {
          text: 'SELECT * FROM simulation.tb_ens_meridional WHERE name = $1 ORDER BY ts ASC',
          values: [typname],
        }
      }
      client.query(selection, (err, result) => {
      ...
      var selection1 = {
          text: 'SELECT * FROM simulation.tb_ens_error WHERE name = $1 AND type = $2 ORDER BY ts ASC LIMIT 21',
          values: [typname,'combine'],
      }
      var selection2 = {
          text: 'SELECT * FROM simulation.tb_act_coord_sample WHERE name = $1 ORDER BY ts ASC',
          values: [typname],
      }
      ...
      var selection1 = {
          text: 'SELECT * FROM simulation.tb_final_track_prediction WHERE name = $1',
          values: [typname],
      }
      var selection2 = {
